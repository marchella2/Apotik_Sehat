...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="?menu=obat">
          <i class="fas fa-fw fa-plus"></i>
          <span>Data Obat</span></a>
        <a class="nav-link" href="?menu=distributor">
          <i class="fas fa-fw fa-plus"></i>
          <span>Data Distributor</span></a>
        <a class="nav-link" href="?menu=petugas">
          <i class="fas fa-fw fa-plus"></i>
          <span>Data Petugas</span></a>
        <a class="nav-link" href="?menu=pasok">
          <i class="fas fa-fw fa-plus"></i>
        ...
        <a class="nav-link" href="?menu=lapdis">
          <i class="fas fa-align-justify"></i>
        <span>Laporan Distributor</span></a>
        <a class="nav-link" href="?menu=lapen">
          <i class="fas fa-align-justify"></i>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <?php 
            ...
            switch (@$_GET['menu']) {
              case 'laporan';
              include 'cetak_print/index.php';
              break;
            }
            switch (@$_GET['menu']) {
              case 'lapdis';
              include 'cetak_print/distributor.php';
              break;
            }
            switch (@$_GET['menu']){
              case 'penjualan';
            ...
            switch (@$_GET['menu']){
              case 'lapen';
              include 'cetak_print/penjualan.php';
            break;
            }
        ?>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Apotek Sehat 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
