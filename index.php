...
if(isset($_POST['login'])){
  $sql = mysqli_query($con,"SELECT * FROM tb_petugas WHERE username='$_POST[username]' and password='$_POST[password]'");
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block">
                <img src="img/apotek.jpg" class="img-responsive" width="500" height="422" style="background-position: center; background-size: cover;">                
              </div>
              <div class="col-lg-6">
                <div class="p-5">
